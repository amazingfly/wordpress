...
?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<?php if ( get_theme_mod( 'techism_posttime_activate' ) == '0') { ?>
			<?php techism_posted_on(); ?>
		<?php } ?>
		
		<?php if ( get_theme_mod( 'techism_postuser_activate' ) == '0') { ?>
			<?php techism_post_author(); ?>
		<?php } ?>
		</div><!-- .entry-meta -->
		<?php endif; ?>
	...
	<?php if((is_home() || is_archive() || is_category() || is_search() ) && get_theme_mod( 'techism_home_content' ) == '0') : ?>
	...
	<footer class="entry-meta">
		...
		<?php if ( get_theme_mod( 'techism_postcategory_activate' ) == '0') { ?>
			<?php
		...
		<?php if ( ! post_password_required() && ( comments_open() || '0' != get_comments_number() ) && ( get_theme_mod( 'techism_postcommentcount_activate' ) == '0') ) : ?>
		<span class="sep"> | </span>
